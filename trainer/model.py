...
INPUT_COLUMNS = [
    ...
    layers.real_valued_column('levels_played'),
    layers.real_valued_column('levels_won'),
    layers.real_valued_column('levels_lost'),
    layers.real_valued_column('days_since_install'),
    layers.real_valued_column('affluence'),
    layers.real_valued_column('grind'),
    layers.real_valued_column('skill'),
    layers.real_valued_column('engagement'),
    layers.real_valued_column('experience'),
